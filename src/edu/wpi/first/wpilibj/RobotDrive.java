...
/**
 * MODIFIED Utility class for handling Robot drive based on a definition of the motor configuration.
...
public class RobotDrive implements MotorSafety, IUtility {
    ...
    public void mecanumDrive_Cartesian(double x, double y, double rotation, double gyroAngle)
    {
        ...
        // Fixed Same Direction Strafing Issue, Changed Front Left and Rear Left x Value
     ...
     * @param direction The direction the robot should drive in degrees. The direction and magnitude are
